        ...
        >
            ...
            <div className="flex items-center justify-between mt-2.5">
                <span className="text-[13px] font-black text-foreground tracking-tight">
                    {formatBRL(Number(lead.total_value || 0) || Number(lead.value || 0) || 0)}
                </span>
...
export default function FunilKanbanPage() {
    ...
    const totalValue = leads.reduce((acc, l) => acc + (Number(l.total_value || 0) || Number(l.value || 0) || 0), 0);
                ...
                <DragDropContext onDragEnd={onDragEnd}>
                    <div className="flex gap-3 flex-1 overflow-x-auto overflow-y-hidden pb-2">
                        {STAGES.map((stage) => {
                            ...
                            const stageValue = stageLeads.reduce((acc, l) => acc + (Number(l.total_value || 0) || Number(l.value || 0) || 0), 0);
