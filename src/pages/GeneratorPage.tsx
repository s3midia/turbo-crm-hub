...
import {
    Globe, Building2, User, Phone, MapPin, Image as ImageIcon,
...
const TEMPLATES = [
    // Advocacia
    { id: 'advocacia', label: 'Advocacia Classic', category: 'advocacia', color: '#b45309', desc: 'Design tradicional e sóbrio', thumbnail: '/thumbnails/advocacia.png' },
    { id: 'advocacia_premium', label: 'Advocacia Premium', category: 'advocacia', color: '#92400e', desc: 'Elegância e exclusividade', thumbnail: '/thumbnails/advocacia.png' },
    { id: 'consultoria_juridica', label: 'Consultoria Jurídica', category: 'advocacia', color: '#1e40af', desc: 'Foco em prevenção e compliance', thumbnail: '/thumbnails/advocacia.png' },
    { id: 'advocacia_moderna', label: 'Advocacia Digital', category: 'advocacia', color: '#60a5fa', desc: 'Inovação e tecnologia jurídica', thumbnail: '/thumbnails/advocacia.png' },
    
    // Engenharia / Construção
    { id: 'construcao', label: 'Construção Civil', category: 'engenharia', color: '#D97706', desc: 'Foco em obras e empreiteiras', thumbnail: '/thumbnails/engenharia.png' },
    { id: 'engenharia_premium', label: 'Engenharia Premium', category: 'engenharia', color: '#ea580c', desc: 'Alta performance estrutural', thumbnail: '/thumbnails/engenharia.png' },
    { id: 'obras_e_projetos', label: 'Obras & Projetos', category: 'engenharia', color: '#111827', desc: 'Gerenciamento completo', thumbnail: '/thumbnails/engenharia.png' },
    { id: 'engenharia_estrutural', label: 'Engenharia Estrutural', category: 'engenharia', color: '#000000', desc: 'Cálculos e precisão técnica', thumbnail: '/thumbnails/engenharia.png' },
    
    // Saúde
    { id: 'saude', label: 'Saúde & Bem-estar', category: 'saude', color: '#0ea5e9', desc: 'Clínicas e consultórios', thumbnail: '/thumbnails/saude.png' },
    
    // Varejo
    { id: 'varejo', label: 'Varejo & E-commerce', category: 'varejo', color: '#7c3aed', desc: 'Lojas e comércio em geral', thumbnail: '/thumbnails/varejo.png' },
];
...
export default function GeneratorPage() {
    ...
    const [selectedTemplate, setSelectedTemplate] = useState('construcao');
            ...
            <div className="w-64 border-r border-wa-border bg-wa-surface flex flex-col h-full shrink-0">
                ...
                <div className="p-4 mt-auto">
                    <div className="p-3 bg-primary/5 rounded-xl border border-primary/10">
                        ...
                        <p className="text-[11px] text-wa-text-muted leading-tight">Templates de engenharia e advocacia possuem variações premium.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="max-w-5xl mx-auto p-6 md:p-8 space-y-8">
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <div>
                            <h1 className="text-3xl font-bold text-wa-text-main flex items-center gap-3">
                            ...
                            <CardContent>
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            <Label className="flex items-center gap-2"><ImageIcon className="h-4 w-4 text-primary" /> URL da Logo</Label>
                                            <Input name="logo_url" placeholder="https://..." value={formData.logo_url} onChange={handleChange} className="bg-wa-bg-subtle h-11 border-wa-border" />
                                        </div>
                                        <div className="space-y-2">
                                        ...
                                        <div className="space-y-2 md:col-span-2">
                                            <Label className="flex items-center gap-2"><Map className="h-4 w-4 text-primary" /> Região de Atuação Principal</Label>
                                    ...
                                    <div className="pt-4">
                                        <Button type="submit" disabled={loading || !formData.company_name} className="w-full md:w-auto h-12 px-10 text-base font-bold shadow-lg shadow-primary/20">
                                            {loading ? <><Loader2 className="mr-2 h-5 w-5 animate-spin" />Gerando Site...</> : <><Globe className="mr-2 h-5 w-5" />Gerar Landing Page Agora</>}
                                        </Button>
                                    </div>
                                </form>
